...
async function checkout(){
  ...
  return (
        <div className="h-screen align-middle items-center justify-center flex p-10">
            <div className="bg-white px-4 mt-2 sm:py-10 sm:px-6 lg:max-w-7xl w-full rounded mb-8 align-middle">
